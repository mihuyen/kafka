...
public class MessageController {
    ...
    public ResponseEntity<Map<String, Long>> getMessageCount() {
        ...
        Long processed = messageRepository.countProcessedMessages();
        Long unprocessed = messageRepository.countUnprocessedMessages();
    ...
    public ResponseEntity<Map<String, Object>> getStats() {
        ...
        Long processedCount = messageRepository.countProcessedMessages();
        Long unprocessedCount = messageRepository.countUnprocessedMessages();
